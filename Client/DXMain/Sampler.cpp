...
shared_ptr<CSampler> CSampler::CreateSampler(UINT Slot, UINT BindFlags, D3D11_TEXTURE_ADDRESS_MODE Mode, D3D11_FILTER Filter, D3D11_COMPARISON_FUNC ComparisionFunc, float MinLOD, float MaxLOD, float BorderColor, UINT MaxAnisotropy){
	...
	d3dSamplerDesc.MaxAnisotropy = MaxAnisotropy;
